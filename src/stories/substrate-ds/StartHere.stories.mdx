...
the Astro Space UX Design System ("Substrate DS"). This demonstration is built using the open source tool
...
using static HTML. For more about the Substrate DS purpose and approach to space app experiences, check out <a href="https://www.astrouxds.com/" target="_blank">AstroUXDS.com</a>.
