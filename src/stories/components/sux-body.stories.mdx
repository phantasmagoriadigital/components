...
export const HeadingSize = args => {
  return html`
    <div style="padding: 10%; justify-content: center; gap:16px;">
      <sux-heading size="xs" classification="sans-serif" weight="regular"> Extra Small heading </sux-heading>
      <sux-heading size="s" classification="sans-serif" weight="regular"> Small heading </sux-heading>
      <sux-heading size="m" classification="sans-serif" weight="regular"> Medium heading </sux-heading>
      <sux-heading size="l" classification="sans-serif" weight="regular"> Large heading </sux-heading>
      <sux-heading size="xl" classification="sans-serif" weight="regular"> X Large heading </sux-heading>
      <sux-heading size="xxl" classification="sans-serif" weight="regular"> XX Large heading </sux-heading>
      <br />
    </div>
  `;
};
