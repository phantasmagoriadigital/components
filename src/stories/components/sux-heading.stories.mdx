...
export const DefaultHeading = args => {
  return html`
    <div style="padding: 10%; justify-content: center; gap:16px;">
      <sux-heading .size="${args.size}" .variant="${args.variant}" .weight="${args.weight}" .tag="${args.tag}"> Headings are great to create hierarchy. </sux-heading>
      <br />
      <sux-heading size="l" variant="sans-serif" weight="regular"> Headings are great to create hierarchy. </sux-heading>
      <br />
      <sux-heading size="l" variant="mono" weight="regular"> Headings are great to create hierarchy. </sux-heading>
    </div>
  `;
};
...
export const HeadingClassification = args => {
  return html`
    <div style="padding: 10%; justify-content: center; gap:16px;">
      <sux-heading size="l" variant="sans-serif" weight="regular"> A Sans Serif Heading looks like this. </sux-heading>
      <sux-heading size="m" variant="sans-serif" weight="regular"> A Sans Serif Heading looks like this. </sux-heading>
      <sux-heading size="s" variant="sans-serif" weight="regular"> A Sans Serif Heading looks like this. </sux-heading>
      <br />
      <sux-heading size="l" variant="serif" weight="regular"> A Serif Heading looks like this. </sux-heading>
      <sux-heading size="m" variant="serif" weight="regular"> A Serif Heading looks like this. </sux-heading>
      <sux-heading size="s" variant="serif" weight="regular"> A Serif Heading looks like this. </sux-heading>
      <br />
      <sux-heading size="l" variant="mono" weight="regular"> A Monospace Heading looks like this. </sux-heading>
      <sux-heading size="m" variant="mono" weight="regular"> A Monospace Heading looks like this. </sux-heading>
      <sux-heading size="s" variant="mono" weight="regular"> A Monospace Heading looks like this. </sux-heading>
    </div>
  `;
};
